...
<div> num1 값과 num2 ${!empty param.num1 and !empty param.num2
			? '둘 다 있다': '값이  둘다 있지 않다'}</div>
<div>num1값 과 num2값이 ${empty param.num1 || empty param.num2 
			? '둘 중 적어도 한 개는 값이 없다':'둘 다 값이 있다'}</div>	
<div>num1값 과 num2값이 ${empty param.num1 or empty param.num2 
? '둘 중 적어도 한 개는 값이 없다':'둘 다 값이 있다'}</div>		
